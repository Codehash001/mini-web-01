  ...
  return (
    <>
      <Head>
        ...
        <div className="absolute md:bottom-[20px] bottom-10 flex flex-col items-center w-screen">
        ...
        <Link className="cursor-pointer mt-4" activeClass ="active" to='footer' spy={true} smooth={true} offset={-70} duration={500}>
